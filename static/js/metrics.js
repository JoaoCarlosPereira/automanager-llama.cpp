...
import { getTabActionsHtml, refreshPlatformTabsFromStatus } from './models.js?v=4.2.19';
import { updateProxyPanel } from './proxy.js?v=4.2.19';
            ...
            if (recoveryTab) {
                ...
                if (recovery.failed) {
                    ...
                    if (recovery.smart_proposal) {
                        import('./models.js?v=4.2.19').then(m => {
